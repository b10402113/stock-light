...
1. Check $ARGUMENTS (after "load"):
   - If it's multiple words: Use as inline feature description, generate detail feature spec
   - If empty: Error - "load" requires a spec filename or feature description
2. Create $feature_name.md under `@context/features/`:
   - Following the format of `@context/features/feature-template.md`
   - Plan and Write down the feature spec detail
   - Do not edit any other file
3. Show the feature summary
